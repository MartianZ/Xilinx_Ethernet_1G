...
#
# Generated by export_simulation on Wed Mar 06 14:11:53 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './fifo_x.sh' script.
...
./fifo_x.sh -noclean_files

For more information on the script, please type './fifo_x.sh -help'.
